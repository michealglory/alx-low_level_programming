...
void close_all_elf(int elf);

/**
 * validate_elf - Checks to be sure if a file is an ELF file.
...
/**
 * print_elf_magic - Prints out the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
...
/**
 * print_elf_class - Prints out the class of an ELF header.
...
/**
 * print_elf_data - Prints out the data of an ELF header.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_elf_data(unsigned char *e_ident)
{
...
/**
 * print_elf_version - Prints out the version of an ELF header.
...
/**
 * print_elf_osabi - Prints out the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void print_elf_osabi(unsigned char *e_ident)
{
...
/**
 * print_elf_abi - Prints out the ABI version of an ELF header.
...
/**
 * close_all_elf - Closes an ELF file.
